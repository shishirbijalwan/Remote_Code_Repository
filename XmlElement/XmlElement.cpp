...
int main()
{
  ...
  name->addChild(makeTextElement("File1.txt"));
  root->addChild(name);
  //////////////////////////////////////////
  /////Adding owner
  sPtr owner = makeTaggedElement("Owner");
  owner->addChild(makeTextElement("8080"));
  root->addChild(owner);
  ///////////////////////////////
 ///Creating sub Root Under XML to hold Dependency
  ...
  child1->addChild(makeTextElement("File2.txt"));
  Deps->addChild(child1);
  sPtr child2 = makeTaggedElement("Dep");
  child2->addChild(makeTextElement("File3.txt"));
  Deps->addChild(child2);
  ///// Adding Frozen to the XML document
  sPtr Frozen = makeTaggedElement("Frozen");
  Frozen->addChild(makeTextElement("NO"));
